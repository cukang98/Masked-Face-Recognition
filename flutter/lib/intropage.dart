...
import 'package:login_page_day_23/carousel_slidder.dart';
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 20,),
                  FadeAnimation(1.2, Text("Automatic identity verification with face recognition which enables you to verify your identity", 
              ...
              Column(
                children: <Widget>[
                  FadeAnimation(1.25, MaterialButton(
